...
class ValidatePassword implements Rule
{
    ...
    public function message()
    {
        ...
        switch (true) {
            ...
            case $this->requireLowercase
                && ! $this->requireUppercase
                && ! $this->requireNumeric
                && ! $this->requireSpecialCharacter:
                return __('The :attribute must be at least :length characters and contain at least one lowercase character.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                ...
                && ! $this->requireNumeric
                && ! $this->requireSpecialCharacter:
                return __('The :attribute must be at least :length characters and contain at least one uppercase character and one lowercase character.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireNumeric
                ...
                && ! $this->requireUppercase
                && ! $this->requireSpecialCharacter:
                return __('The :attribute must be at least :length characters and contain at least one lowercase character and one number.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireLowercase
                ...
                && ! $this->requireUppercase
                && ! $this->requireNumeric:
                return __('The :attribute must be at least :length characters and contain at least one special character and one lowercase character.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireUppercase
                ...
                && $this->requireNumeric
                && ! $this->requireSpecialCharacter:
                return __('The :attribute must be at least :length characters and contain at least one uppercase character, one lowercase character, and one special character.', [
                    'length' => $this->length,
                ]);
            case $this->requireSpecialCharacter
                && $this->requireLowercase
                && $this->requireNumeric
                && ! $this->requireUppercase:
                return __('The :attribute must be at least :length characters and contain at least one lowercase character, one number, and one special character.', [
                    'length' => $this->length,
                ]);
            ...
            case $this->requireSpecialCharacter
                ...
                && $this->requireNumeric
                && $this->requireUppercase:
                return __('The :attribute must be at least :length characters and contain at least one uppercase character, one lowercase character, one number, and one special character.', [
                    'length' => $this->length,
                ]);
