...
{
    use NodeTrait, LogsActivityTrait;

    protected static $logName = 'menu';
    protected static $logAttributes = ['title', 'parent_id', 'url', 'icon', 'menu_order'];

    protected $table = "menu";

    protected $fillable = ['title', 'parent_id', 'url', 'icon', 'menu_order'];
