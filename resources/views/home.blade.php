...
@push('styles')
    <link rel="stylesheet" href="{{asset('plugins/dashforge/css/dashforge.dashboard.css')}}">
@endpush
@push('scripts')
    <script type="module" src="{{asset('plugins/ionicons/ionicons/ionicons.esm.js')}}"></script>
    ...
    <script src="{{asset('plugins/dashforge/js/dashforge.sampledata.js')}}"></script>
    <script src="{{asset('plugins/dashforge/js/dashboard-two.js')}}"></script>
@endpush
@section('content')
